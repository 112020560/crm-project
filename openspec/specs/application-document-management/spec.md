...
Defines how documents are registered and validated within a credit application. ApplicationDocuments are scoped to a CreditApplication and are distinct from CustomerDocuments.
