...
Defines how risk rules and risk matrices are created, configured, and managed. Covers rule types, weighting, matrix versioning, and the activation lifecycle that governs which matrix is used for risk evaluation.
